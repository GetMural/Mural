...
router.post('/page/imageaudio/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    const suppress = newItem.suppress === 'on';
...
router.get('/page/imagebackground/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    if (query.params && query.params.id) {
      qId = query.params.id;
      item = items[qId].imagebackground;
    };
...
router.post('/page/imagebackground/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    // format and save new item
    const fullpage = newItem.fullpage === 'on';
    ...
    const gradientEnable = newItem.gradientEnable === 'on';
    const gradientAnimate = newItem.gradientAnimate === 'on';
    const gradientDirection = newItem.gradientDirection;
    const gradientSpeed = newItem.speed;
    const gradientStops = newItem.stops;
    const gradientAnimTop = newItem.gradientAnimTop === 'on';
    const gradientAnimTopRight = newItem.gradientAnimTopRight === 'on';
    const gradientAnimRight = newItem.gradientAnimRight === 'on';
    const gradientAnimBottomRight = newItem.gradientAnimBottomRight === 'on';
    const gradientAnimBottom = newItem.gradientAnimBottom === 'on';
    const gradientAnimBottomLeft = newItem.gradientAnimBottomLeft === 'on';
    const gradientAnimLeft = newItem.gradientAnimLeft === 'on';
    const gradientAnimTopLeft = newItem.gradientAnimTopLeft === 'on';
    const gradientAnim = {
      top: gradientAnimTop,
...
router.get('/page/slideshowvertical/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    if (query.params && query.params.id) {
      qId = query.params.id;
      item = items[qId].slideshowvertical;
    };
...
router.get('/page/videobackground/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    if (query.params && query.params.id) {
      qId = query.params.id;
      item = items[qId].videobackground;
    };
...
router.post('/page/videobackground/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    const offsetLeft = newItem['offset-left'] === 'on';
    const offsetCentre = newItem['offset-centre'] === 'on';
    const offsetRight = newItem['offset-right'] === 'on';
    const offsetCustom = newItem['offset-custom'] === 'on';
    item.offset = {
      left: offsetLeft,
      centre: offsetCentre,
      right: offsetRight,
...
router.post('/page/videofullpage/id/:id', function (req, res) {
  storyboard.readFile(function (err, data) {
    ...
    item.suppress = suppress;
    item.nav_title = newItem.nav_title;
    const playback = newItem.playback;
    if (playback === 'advance') {
