...
var blueimp = __webpack_require__(1);

__webpack_require__(13);

var videoMedia = __webpack_require__(14);

var imageMedia = __webpack_require__(16);

var audioMedia = __webpack_require__(17);

var youtubeMedia = __webpack_require__(18);

var isMobile = window.isMobile; // Override this function so we can change the arrow keys.
...
function prepMediaElements(scrollStory) {
  ...
  var items = scrollStory.getItems();
...
function loadItem(item) {
  ...
  if (item.data.image) {
    var imageLoaded = imageMedia.insertBackgroundImage(item.el, item.data[scrKey]).then(function (shouldUpdateOffsets) {
  ...
  if (item.data.slideshow) {
    ...
    var horizontalSlidePromise = Promise.all(slidePromises).then(function () {
      blueimp(slides, {
        ...
        toggleControlsOnEnter: false,
        storyItem: item,
        // use this in our custom keydown mod.
        onslide: function onslide(index, slide) {
          var _this = this;

          var info = [{
            selector: ".slide-caption",
            attr: "title"
          }, {
            selector: ".credits",
            attr: "data-credits"
          ...
          info.forEach(function (_ref) {
            ...
            var text = _this.list[index].getAttribute(attr);

            var $node = $(_this.container).parent().find(selector);
            $node.empty();
  ...
  if (item.data.audio) {
    var audioLoaded = audioMedia.prepareAudio(scrollStory, item.el, item.index, [{
      type: "audio/mp3",
      src: item.data.mp3
    }, {
      type: "audio/ogg",
...
Promise.all(LOAD_PROMISES).then(function () {
  ...
  playStart.addEventListener("click", function () {
    var MURAL_MEDIA = scrollStory.MURAL_AUDIO.concat(scrollStory.MURAL_VIDEO); // load a media element within scope of the user gesture to make sure Safari works.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__stickybits__ = __webpack_require__(12);
...
if (typeof window !== 'undefined') {
  ...
  if (plugin) {
    plugin.fn.stickybits = function stickybitsPlugin(opts) {
      return Object(__WEBPACK_IMPORTED_MODULE_0__stickybits__["a" /* default */])(this, opts);
    };
  }
}
...
var Stickybits = /*#__PURE__*/function () {
  function Stickybits(target, obj) {
    ...
    */
    ...
    var verticalPositionStyle = verticalPosition === 'top' && !noStyles ? "".concat(stickyBitStickyOffset, "px") : '';
    ...
    for (var i = 0; i < this.els.length; i++) {
      ...
      this.props.applyStyle({
        styles: (_styles = {}, _defineProperty(_styles, verticalPosition, verticalPositionStyle), _defineProperty(_styles, "position", positionStyle), _styles),
        classes: {}
      }, instance);
  ...
  */
  ...
  _createClass(Stickybits, [{
    ...
    */
    ...
    key: "getTopPosition",
    value: function getTopPosition(el) {
    ...
    value: function manageState(item) {
      ...
      */
      ...
      rAF(function () {
        ...
        var stateStyles = {
          sticky: {
            styles: _defineProperty({
              ...
              top: '',
              bottom: ''
            }, vp, "".concat(p.stickyBitStickyOffset, "px")),
            classes: _defineProperty({}, sticky, true)
          },
          "default": {
            styles: _defineProperty({}, vp, ''),
            classes: {}
          },
          stuck: {
            styles: _objectSpread(_defineProperty({}, vp, ''), pv === 'fixed' && !ns || !_this3.isWin ? {
              position: 'absolute',
              top: '',
              bottom: '0'
            } : {}),
            classes: _defineProperty({}, stuck, true)
          }
        };
        ...
        style.classes = (_style$classes = {}, _defineProperty(_style$classes, stuck, !!style.classes[stuck]), _defineProperty(_style$classes, sticky, !!style.classes[sticky]), _defineProperty(_style$classes, stickyChange, isStickyChange), _style$classes);
        aS(style, item);
      });
    }
    /*
    ...
    */
    ...
    key: "applyStyle",
    value: function applyStyle(_ref, item) {
    ...
    value: function update() {
      ...
      var updatedProps = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    */
    ...
    value: function removeInstance(instance) {
      ...
      this.applyStyle({
        ...
        classes: (_classes3 = {}, _defineProperty(_classes3, p.stickyClass, ''), _defineProperty(_classes3, p.stuckClass, ''), _classes3)
      }, instance);
...
var mediaUtils = __webpack_require__(3);

var Hls = __webpack_require__(15);
...
function prepareVideo(scrollStory, $el, id, srcs, attrs) {
  var video = scrollStory.MURAL_VIDEO[id];
...
function prepareAudio(scrollStory, $el, id, srcs, attrs) {
  var audio = scrollStory.MURAL_AUDIO[id];
  MEDIA[id] = audio;
  DATA[id] = {};
...
/***/ })
/******/ ]);
//# sourceMappingURL=app.b1cedf1cbb0347362cde.js.map